...
This is a simple ERC-20 token contract implemented in Solidity Named ORION(ORI). The contract allows for the creation and destruction of tokens, as well as storing information about the token.
